	...
	<body>
		<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<c:forEach items="${hots}" var="p">
						...
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							...
							<p><a href="${pageContext.request.contextPath}/ProductServlet?method=findProByPid&pid=${p.pid} " style='color:#666'>${p.pname}</a></p>
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					<div class="col-md-6" style="text-align:center;height:200px;padding:0px;">
						<a href="${pageContext.request.contextPath}/ProductServlet?method=findProByPid&pid=${n.pid}">
							<img src="products/hao/middle01.jpg" width="516px" height="200px" style="display: inline-block;">
						</a>
					</div>
					...
					<c:forEach items="${news}" var="n">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px ;">
							...
							<p><a href="${pageContext.request.contextPath}/ProductServlet?method=findProByPid&pid=${n.pid}" style='color:#666'>${n.pname}</a></p>
